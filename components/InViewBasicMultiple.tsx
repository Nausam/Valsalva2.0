        ...
        >
          <div className="max-w-96 bg-zinc-100 p-4">
            <p className="text-zinc-600">
              <strong className="font-medium text-zinc-900">About Us</strong> We
              specialize in premium snorkeling equipment, designed to elevate
              your underwater experience. With a focus on innovation and
              quality, our products help you explore the ocean with ease and
              style.
            </p>
          </div>
        </InView>
